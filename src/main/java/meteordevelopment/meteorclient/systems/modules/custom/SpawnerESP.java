...
public class SpawnerESP extends Module {
    ...
    private final Setting<Double> range = sgGeneral.add(new DoubleSetting.Builder()
        .name("range")
        .description("The radius in blocks to scan for spawners.")
        .defaultValue(24.0)
        .min(4.0)
        .max(64.0)
        .sliderMin(4.0)
    ...
    private final Setting<SettingColor> color = sgGeneral.add(new ColorSetting.Builder()
        .name("color")
        .description("The color of the spawner highlight.")
    ...
    public SpawnerESP() {
        super(Categories.Render, "spawner-esp", "Highlights monster spawners around you so you can find or avoid mob farms.");
    }
